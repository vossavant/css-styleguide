<?php require_once('../header.php'); ?>
    ...
    <div class="section align-center gradient">
        <div class="wrap">
            <div class="row">
                <div class="width-100">
                    <h1>Utility Class: Align Top</h1>
                    <p>Applies to a parent with <b>display: flex</b>, and aligns child content to the top of the parent. This is the default styling, so this class is only really needed to override different alignment on a parent element.</p>
                    <a class="button" href="https://github.com/gospotcheck/styleguide/#17.1.6"><i class="material-icons left">chevron_left</i> Back to Readme</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="section off-white">
        <div class="wrap">
            <div class="row">
                ...
                <div class="width-50 align-top">
                    <p>Some top-aligned content.</p>
                </div>
            </div>
        </div>
    </div>
