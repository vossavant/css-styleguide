<?php require_once('../header.php'); ?>
    ...
    <div class="section align-center gradient">
        <div class="wrap">
            <div class="row">
                <div class="width-100">
                    <h1>Utility Class: Align Right</h1>
                    <p>Aligns content (text and images) to the right. Also applies to a parent with <b>display: flex</b>, and aligns child content to the right of the parent.</p>
                    <a class="button" href="https://github.com/gospotcheck/styleguide/#17.1.5"><i class="material-icons left">chevron_left</i> Back to Readme</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="section align-center off-white">
        <div class="wrap">
            <div class="row">
                ...
                <div class="width-50 align-right">
        ...
        <div class="wrap">
            <div class="row align-center">
                <div class="width-100">
                    ...
                    <p>With application of the <b>align-right</b> class, the children move to the far right. More specific <b>align-center</b> classes keep the contents of the children centered.</p>
                    <ul class="flex icon align-right">
